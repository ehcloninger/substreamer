 ...
 */
export async function setSleepTimer(seconds: number): Promise<void> {
 ...
 */
export async function getSleepTimer(): Promise<SleepTimerChangedEvent> {
  return (await TrackPlayer.getSleepTimer()) as SleepTimerChangedEvent;
}
