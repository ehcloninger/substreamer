...
const FLAG_FILE_NAME = 'audio-diagnostics-enabled';
const LOG_FILE_NAME = 'audio-diagnostics.log';
const OLD_LOG_FILE_NAME = 'audio-diagnostics.old.log';
...
export const audioDiagnosticsStore = create<AudioDiagnosticsState>()((set) => ({
  enabled: false,
  logFileSize: null,
